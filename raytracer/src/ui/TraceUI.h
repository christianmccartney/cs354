...
public:
	TraceUI()
		: m_nDepth(0), m_nSize(512), m_nBlockSize(4), m_nThreshold(0), m_nSuperSamples(3),
			m_nAaThreshold(100), m_nTreeDepth(15), m_nLeafSize(10), m_nFilterWidth(1),
		m_displayDebuggingInfo(false), m_antiAlias(false), m_kdTree(false),
			m_shadows(true), m_smoothshade(true), m_usingCubeMap(true), m_backface(true),
		raytracer(0)
